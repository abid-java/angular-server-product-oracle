-- FUNCTION: public.updateproduct_location(json, bigint, bigint)

-- DROP FUNCTION public.updateproduct_location(json, bigint, bigint);

CREATE OR REPLACE FUNCTION public.updateproduct_location(
	v_product_location json,
	v_product_id bigint,
	v_productlocation_product_id bigint)
...
WHERE product_id = v_productlocation_product_id and pc_fid=v_product_id;

return 'success';
end;
$BODY$;

ALTER FUNCTION public.updateproduct_location(json, bigint, bigint)
    OWNER TO postgres;
